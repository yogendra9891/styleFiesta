...
route.use(function(req, res, next) {
  ...
  var rules = {
    ...
    shipping_region_id: Check.that(input.shipping_address.region_id).isOptional().isInteger(),
    ...
    billing_region_id: Check.that(input.billing_address.region_id).isOptional().isInteger(),
