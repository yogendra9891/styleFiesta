 ...
 * @constructor
 */
function ApiException(httpCode, errorCode, message, cause, statusCode) {
...
ApiException.EC_NOT_FOUND = "NOT_FOUND";
...
ApiException.MAGENTO_ERROR = 200;
ApiException.MSG_MAGENTO_ERROR = "Some error in magento processing";
...
ApiException.newBadRequestError = function(cause) {
  return new ApiException(ApiException.SC_BAD_REQUEST, ApiException.EC_BAD_REQUEST,
    ApiException.MSG_BAD_REQUEST, cause, ApiException.SC_BAD_REQUEST);
};
...
ApiException.newUnauthorizedError = function(errorCode, cause) {
  return new ApiException(ApiException.SC_UNAUTHORIZED, errorCode,
    ApiException.MSG_UNAUTHORIZED, cause);
};
...
ApiException.newNotAllowedError = function(errorCode, cause) {
  return new ApiException(ApiException.SC_FORBIDDEN, errorCode, ApiException.MSG_FORBIDDEN,
    cause);
};
...
ApiException.newNotFoundError = function(cause) {
  return new ApiException(ApiException.SC_NOT_FOUND, ApiException.EC_NOT_FOUND,
    ApiException.MSG_NOT_FOUND, cause);
};
...
ApiException.newInternalError = function(cause) {
  return new ApiException(ApiException.SC_INTERNAL_ERROR, ApiException.EC_INTERNAL_ERROR,
    ApiException.MSG_INTERNAL_ERROR, cause);
};

/**
 * Create a new API Exception for handeling magento errors.
 * @param {String} errorCode - error code.
 * @param {Object} cause - optional cause.
 * @returns {ApiException}
 */
ApiException.newMagentoError = function(errorCode, cause, statusCode) {
  return new ApiException(ApiException.MAGENTO_ERROR, errorCode, ApiException
    .MSG_MAGENTO_ERROR,
    cause, statusCode);
};
